          ...
          <div>
            ...
            <div className="mt-4">
              ...
              <div className="flex space-x-3">
                <a href="https://www.facebook.com/profoundIQ" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#1877F2] transition-colors">
                ...
                <a href="https://www.youtube.com/@ProfoundIQConsulting" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#FF0000] transition-colors">
                  <YoutubeIcon className="h-5 w-5" />
                </a>
                <a href="https://www.instagram.com/profoundiqconsulting/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#E4405F] transition-colors">
                  <InstagramIcon className="h-5 w-5" />
                </a>
                <a href="https://linkedin.com/company/profound-iq-consulting" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#0A66C2] transition-colors">
